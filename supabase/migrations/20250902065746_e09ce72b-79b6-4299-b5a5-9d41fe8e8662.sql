...
SELECT 
  ...
  unnest(ARRAY[
    'Get started with Python syntax and your first program',
    ...
    'Connect to web APIs and process JSON data',
    'Build a complete Python application'
  ]),
  unnest(ARRAY[
    '{"type": "lesson", "content": "Welcome to Python! Let''s write your first program.", "exercises": [{"type": "code", "prompt": "Write a program that prints ''Hello, World!''", "solution": "print(''Hello, World!'')"}]}',
    '{"type": "lesson", "content": "Variables store data that can be used throughout your program.", "exercises": [{"type": "code", "prompt": "Create a variable called name and assign it your name", "solution": "name = ''Your Name''"}]}',
    '{"type": "lesson", "content": "Control structures help you make decisions in your code.", "exercises": [{"type": "code", "prompt": "Write an if statement that checks if a number is positive", "solution": "if number > 0:\\n    print(''Positive'')"}]}',
    '{"type": "lesson", "content": "Functions allow you to organize and reuse your code.", "exercises": [{"type": "code", "prompt": "Create a function that adds two numbers", "solution": "def add_numbers(a, b):\\n    return a + b"}]}',
    '{"type": "lesson", "content": "Lists and dictionaries are essential data structures in Python.", "exercises": [{"type": "code", "prompt": "Create a list of your favorite foods", "solution": "foods = [''pizza'', ''sushi'', ''tacos'']"}]}',
    '{"type": "lesson", "content": "Learn to read from and write to files.", "exercises": [{"type": "code", "prompt": "Write code to read a text file", "solution": "with open(''file.txt'', ''r'') as f:\\n    content = f.read()"}]}',
    '{"type": "lesson", "content": "Handle errors gracefully to make robust programs.", "exercises": [{"type": "code", "prompt": "Use try-except to handle a division by zero error", "solution": "try:\\n    result = 10 / 0\\nexcept ZeroDivisionError:\\n    print(''Cannot divide by zero'')"}]}',
    '{"type": "lesson", "content": "Object-oriented programming helps organize complex programs.", "exercises": [{"type": "code", "prompt": "Create a simple Car class", "solution": "class Car:\\n    def __init__(self, brand):\\n        self.brand = brand"}]}',
    '{"type": "lesson", "content": "APIs let you connect to external services and data.", "exercises": [{"type": "code", "prompt": "Import the requests library", "solution": "import requests"}]}',
    '{"type": "lesson", "content": "Put everything together in a final project.", "exercises": [{"type": "project", "prompt": "Build a simple calculator app", "solution": "# Complete calculator implementation"}]}'
  ]),
  generate_series(1, 10),
  unnest(ARRAY[15, 20, 25, 30, 25, 20, 25, 35, 30, 50]),
  unnest(ARRAY[30, 45, 60, 75, 60, 45, 60, 90, 75, 120])
FROM public.courses c WHERE c.title = 'Python Fundamentals';
